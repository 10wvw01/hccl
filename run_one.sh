...
$STBUILD/testcase/hccl_checker_ops_stest --gtest_filter="ST_BROADCAST_3LEVEL_TEST.st_broadcast_3level_2x4x1_fp32_one_card_per_server" --gtest_brief=1 2>&1 | grep -E "Error|FAILED|PASSED|sel|Algo|Missing|conflict|rankId" | head -20
