...
- [方案对比](#方案对比)
  ...
  - [候选方案对比](#候选方案对比)
  - [规模趋势总结](#规模趋势总结)
- [选定方案：拍平 NHR，全 AICPU](#选定方案拍平-nhr全-aicpu)
  - [执行流程](#执行流程)
  - [选型理由](#选型理由)
  - [性能权衡](#性能权衡)
- [范围边界](#范围边界)
...
- [关键设计决策](#关键设计决策)
  ...
  - [Executor 复用 SoleExecutor + TopoMatch1D](#executor-复用-soleexecutor--topomatch1d)
