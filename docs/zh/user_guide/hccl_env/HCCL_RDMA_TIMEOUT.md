...
- 针对Ascend 950PR/Ascend 950DT，该环境变量配置为整数，取值范围为\[5,20\]，默认值为20。
...
<!-- npu="910" id1 -->
- 针对Atlas 训练系列产品，该环境变量配置为整数，取值范围为\[5,20\]，默认值为20。<!-- end id1 -->
<!-- npu="310p" id2 -->
- 针对Atlas 推理系列产品，该环境变量配置为整数，取值范围是\[5,20\]，默认值为20。<!-- end id2 -->
