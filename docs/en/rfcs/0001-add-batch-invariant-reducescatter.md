...
| Additional scratch memory overhead | Increased memory usage for large messages | Requires `2 * rankSizeY x localStrideSize` scratch space; pre-allocated via `CalcResRequest` |
