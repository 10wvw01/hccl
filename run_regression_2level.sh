...
for SUITE in "ST_BROADCAST_2LEVEL_TEST" "ST_BROADCAST_3LEVEL_TEST" "ST_BROADCAST_TEST" "ST_ALL_GATHER_3LEVEL_TEST" "ST_ALL_REDUCE_MULTILEVEL_TEST" "ST_ALL_REDUCE_TEST" "ST_REDUCE_SCATTER_3LEVEL_TEST" "ST_REDUCE_SCATTER_AICPU_TEST" "ST_REDUCE_TEST"; do
