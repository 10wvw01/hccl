...
#ifndef HCCL_ALLTOALL_COMMON_H
#define HCCL_ALLTOALL_COMMON_H
...
struct AlgResourceCtx {
    ThreadHandle aicpuThread;               ///< AICPU上的Thread句柄
    CommBuffer localBuffer;                 ///< 本端HCCL通信内存
    CommBuffer remoteBuffer;                ///< 对端HCCL通信内存
