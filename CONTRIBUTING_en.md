...
3. System solution design
   ...
   - Create a markdown RFC document in the `docs/zh/rfcs` directory (the filename must start with the registered number) and write the system solution following the [RFC template](./docs/en/rfcs/0000-template.md).
