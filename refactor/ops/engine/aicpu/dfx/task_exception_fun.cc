...
HcclResult ConvertToHcclDfxOpInfo(OpParam *param, HcclDfxOpInfoCompat *hcclDfxOpInfo)
{
    ...
    HCCL_INFO("[%s]HcclDfxOpInfo param: algTag[%s], opMode[%u], opType[%u], reduceOp[%u], dataType[%u], "
        "dataCount[%llu], root[%u], engine[%u], cpuTsThread[%u], cpuWaitAicpuNotifyIdx[%u], "
        "inputMemAddr[0x%llx], inputMemSize[%llu], outputMemAddr[0x%llx], outputMemSize[%llu]",
        __func__, hcclDfxOpInfo->algTag, hcclDfxOpInfo->opMode, hcclDfxOpInfo->opType,
        hcclDfxOpInfo->reduceOp, hcclDfxOpInfo->dataType, hcclDfxOpInfo->dataCount,
        hcclDfxOpInfo->root, hcclDfxOpInfo->engine, hcclDfxOpInfo->cpuTsThread,
        hcclDfxOpInfo->cpuWaitAicpuNotifyIdx, hcclDfxOpInfo->inputMemAddr,
