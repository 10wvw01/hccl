...
#ifndef CANN_VERSION_NUM
#define DLSYM_NO_CANN_VERSION 1
#endif
#if DLSYM_NO_CANN_VERSION || CANN_VERSION_NUM < CANN_VERSION(9, 1, 0, 1)
typedef enum {
...
#if DLSYM_NO_CANN_VERSION || CANN_VERSION_NUM < CANN_VERSION(9, 0, 0)
