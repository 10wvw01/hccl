...
DECL_WEAK_FUNC(CcuResult, HcommCcuKernelRegister, CcuInsHandle insHandle, uint32_t dieId,
...
DECL_WEAK_FUNC(CcuResult, HcommCcuKernelLaunch, ThreadHandle threadHandle,
