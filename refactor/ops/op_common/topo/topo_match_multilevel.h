...
private:
    ...
    HcclResult TopoForLayer3(const HcclComm comm, uint32_t netLayer, uint32_t layer0Size, uint32_t layer1Size,
        uint32_t layer2Size, const uint32_t myRank, AlgHierarchyInfoForAllLevel& algHierarchyInfo) const;
