...
EsCTensorHolder *EsHcomAllReduce(EsCTensorHolder *x, const char *reduction, const char *group, int64_t fusion, int64_t fusion_id) {
  ...
  auto node = ge::es::CompliantNodeBuilder(ge_graph).OpType("HcomAllReduce")
      .Name( builder.GenerateNodeName("HcomAllReduce").GetString())
      .IrDefInputs({
      ...
      .IrDefAttrs({
          ...
          },
          {
              ...
              "Int",
              ge::es::CreateFromIfNotEqual(fusion, static_cast<int64_t>(1))
          },
          {
              "fusion_id",
              ge::es::CompliantNodeBuilder::kEsAttrOptional,
