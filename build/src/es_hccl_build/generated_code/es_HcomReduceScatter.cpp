...
EsCTensorHolder *EsHcomReduceScatter(EsCTensorHolder *x, const char *reduction, const char *group, int64_t rank_size, int64_t fusion, int64_t fusion_id) {
  ...
  auto node = ge::es::CompliantNodeBuilder(ge_graph).OpType("HcomReduceScatter")
      .Name( builder.GenerateNodeName("HcomReduceScatter").GetString())
      .IrDefInputs({
      ...
      .IrDefAttrs({
          ...
          },
          {
              ...
              ge::es::CompliantNodeBuilder::kEsAttrRequired,
              "Int",
              ge::es::CreateFrom(static_cast<int64_t>(rank_size))
          },
      })
      .Build();
