...
# 定义 HcomSend 函数原型
esb_generated_lib.EsHcomSend.argtypes = [EsCTensorHolderPtr, ctypes.c_char_p, ctypes.c_int64, ctypes.c_int64]
esb_generated_lib.EsHcomSend.restype = EsCTensorHolderPtr  # EsCTensorHolder指针

# 创建Python包装函数
def HcomSend(x: TensorHolder, *, group: str, sr_tag: int, dest_rank: int) -> TensorHolder:
    """
    Python wrapper for EsHcomSend function
    Args:
    ...
    # 调用C函数
    _result = esb_generated_lib.EsHcomSend(x._handle, group.encode('utf-8'), sr_tag, dest_rank)
