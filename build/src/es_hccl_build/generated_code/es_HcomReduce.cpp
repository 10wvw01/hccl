...
extern "C" {
#endif
EsCTensorHolder *EsHcomReduce(EsCTensorHolder *x, int64_t root_rank, const char *reduction, const char *group, int64_t fusion, int64_t fusion_id) {
  ES_ASSERT_NOTNULL(x);
  ...
  auto node = ge::es::CompliantNodeBuilder(ge_graph).OpType("HcomReduce")
      .Name( builder.GenerateNodeName("HcomReduce").GetString())
      .IrDefInputs({
