...
extern "C" {
#endif
EsCTensorHolder *EsHcomAllToAll(EsCTensorHolder *x, const char *group) {
  ES_ASSERT_NOTNULL(x);
  ...
  auto node = ge::es::CompliantNodeBuilder(ge_graph).OpType("HcomAllToAll")
      .Name( builder.GenerateNodeName("HcomAllToAll").GetString())
      .IrDefInputs({
