...
execute_process(
  COMMAND "/usr/bin/git" show-ref "master-012"
  WORKING_DIRECTORY "/home/crx/code/hccl_three_sequence_rs/hccl_0701_br_sequence/hccl_2039/build/_deps/cann-cmake-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("master-012" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/master-012")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/crx/code/hccl_three_sequence_rs/hccl_0701_br_sequence/hccl_2039/build/_deps/cann-cmake-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/crx/code/hccl_three_sequence_rs/hccl_0701_br_sequence/hccl_2039/build/_deps/cann-cmake-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
