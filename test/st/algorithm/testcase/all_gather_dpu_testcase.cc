...
TEST_F(ST_ALL_GATHER_DPU_TEST, host_dpu_opbase_all_gather_asymmetric_10m_int16)
{
    TopoMeta topoMeta {{{0, 1}, {0}}};  // 三维数组指定超节点-Server-Device信息
    u64 sendCount = 10 * 1024 * 1024;  // 接收数据量
    HcclDataType dataType = HcclDataType::HCCL_DATA_TYPE_INT16;  // 数据类型
    RunAllGatherDPUA5(topoMeta, sendCount, dataType);
}

TEST_F(ST_ALL_GATHER_DPU_TEST, host_dpu_opbase_all_gather_asymmetric_10m_int32)
{
    TopoMeta topoMeta {{{2, 3}, {4, 5, 6, 7}}};  // 三维数组指定超节点-Server-Device信息
    u64 sendCount = 10 * 1024 * 1024;  // 接收数据量
    HcclDataType dataType = HcclDataType::HCCL_DATA_TYPE_INT32;  // 数据类型
    RunAllGatherDPUA5(topoMeta, sendCount, dataType);
}

TEST_F(ST_ALL_GATHER_DPU_TEST, host_dpu_opbase_all_gather_asymmetric_10m_int64)
{
    TopoMeta topoMeta {{{0}, {1, 3, 5, 7}, {0}, {0, 1, 2, 3, 4, 5, 6, 7}}};  // 三维数组指定超节点-Server-Device信息
    u64 sendCount = 10 * 1024 * 1024;  // 接收数据量
    HcclDataType dataType = HcclDataType::HCCL_DATA_TYPE_INT64;  // 数据类型
    RunAllGatherDPUA5(topoMeta, sendCount, dataType);
}

TEST_F(ST_ALL_GATHER_DPU_TEST, host_dpu_opbase_all_gather_asymmetric_10m_fp16)
{
...
TEST_F(ST_ALL_GATHER_DPU_TEST, host_dpu_opbase_all_gather_asymmetric_10m_fp64)
{
    TopoMeta topoMeta {{{0, 1}, {0}, {1}, {2, 3}, {0, 1, 2, 3, 4, 5, 6, 7}, {0}, {7}}};  // 三维数组指定超节点-Server-Device信息
    u64 sendCount = 10 * 1024 * 1024;  // 接收数据量
    HcclDataType dataType = HcclDataType::HCCL_DATA_TYPE_FP64;  // 数据类型
    RunAllGatherDPUA5(topoMeta, sendCount, dataType);
}

TEST_F(ST_ALL_GATHER_DPU_TEST, host_dpu_opbase_all_gather_asymmetric_10m_bfp16)
{
    TopoMeta topoMeta {{{0, 2, 4}, {1, 3, 5, 7}}};  // 三维数组指定超节点-Server-Device信息
    u64 sendCount = 10 * 1024 * 1024;  // 接收数据量
    HcclDataType dataType = HcclDataType::HCCL_DATA_TYPE_BFP16;  // 数据类型
    RunAllGatherDPUA5(topoMeta, sendCount, dataType);
}
...
TEST_F(ST_ALL_GATHER_DPU_TEST, host_dpu_opbase_all_gather_asymmetric_10m_fp8e4m3)
{
    TopoMeta topoMeta {{{1, 3, 4}, {0, 2, 4, 5, 6, 7}, {2, 3, 5}}};  // 三维数组指定超节点-Server-Device信息
    u64 sendCount = 10 * 1024 * 1024;  // 接收数据量
    HcclDataType dataType = HcclDataType::HCCL_DATA_TYPE_FP8E4M3;  // 数据类型
    RunAllGatherDPUA5(topoMeta, sendCount, dataType);
}

TEST_F(ST_ALL_GATHER_DPU_TEST, host_dpu_opbase_all_gather_asymmetric_10m_fp8e8m0)
{
    TopoMeta topoMeta {{{0, 1, 2, 4, 5, 6, 7}, {0, 1, 2, 3, 4, 5, 6, 7}}};  // 三维数组指定超节点-Server-Device信息
    u64 sendCount = 10 * 1024 * 1024;  // 接收数据量
    HcclDataType dataType = HcclDataType::HCCL_DATA_TYPE_FP8E8M0;  // 数据类型
    RunAllGatherDPUA5(topoMeta, sendCount, dataType);
}
