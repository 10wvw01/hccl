...
TEST_F(ST_ALL_GATHER_AICPU_TEST, st_all_gather_a5_aicpu_NHR_2rank_int64_small_data_test)
{
    // 仿真模型初始化
    TopoMeta topoMeta{{{0}, {1}}}; // 三维数组指定超节点-Server-Device信息
...
TEST_F(ST_ALL_GATHER_AICPU_TEST, st_all_gather_a5_aicpu_NHR_8rank_fp64_small_data_test)
{
    // 仿真模型初始化
    TopoMeta topoMeta{{{0}, {1}, {2}, {3}, {4}, {5}, {6}, {7}}}; // 三维数组指定超节点-Server-Device信息
