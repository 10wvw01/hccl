...
inline const std::unordered_map<CommEngine, std::string> COMMENGINE_STATUS_STR_MAP {
    {COMM_ENGINE_RESERVED, "COMM_ENGINE_RESERVED"},
    {COMM_ENGINE_CPU, "COMM_ENGINE_CPU"},
    {COMM_ENGINE_CPU_TS, "COMM_ENGINE_CPU_TS"},
    {COMM_ENGINE_AICPU, "COMM_ENGINE_AICPU"},
    {COMM_ENGINE_AICPU_TS, "COMM_ENGINE_AICPU_TS"},
    {COMM_ENGINE_AIV, "COMM_ENGINE_AIV"},
    {COMM_ENGINE_CCU, "COMM_ENGINE_CCU"}
};

inline std::string GetCommEngineStr(CommEngine engine)
{
    return GetEnumToString(COMMENGINE_STATUS_STR_MAP, engine);
}
