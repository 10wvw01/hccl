...
constexpr size_t SLICE_ENTRY_SIZE = 4;
...
struct OmniSliceInfo {
    ...
    OmniSliceInfo() : sliceType(DEFAULT), sliceIdx(0), remoteRank(0), remoteRecvRank(0) {}
...
private:
    ...
    OmniSliceInfo ParseSlice(uint32_t sliceValue);
