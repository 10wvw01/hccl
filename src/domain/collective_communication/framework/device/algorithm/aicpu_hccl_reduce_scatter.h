...
#ifndef __AICPU_HCCL_REDUCE_SCATTER_H__
#define __AICPU_HCCL_REDUCE_SCATTER_H__

#include "aicpu_hccl_algorithm.h"

class AicpuHcclReduceScatter : public AicpuHcclAlgorithm {
public:
    explicit AicpuHcclReduceScatter(AicpuComContext *ctx) : AicpuHcclAlgorithm(ctx) {}
    ~AicpuHcclReduceScatter() override = default;
