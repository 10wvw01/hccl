                                                          ...
                                                          TemplateResource& templateResource)
{
    ...
    if (localCopyFlag == 0) {
        ...
        for (uint32_t rpt = 0; rpt < repeatNum; ++rpt) {
            ...
            if (templateDataParams.subRoot == 999) {
                sliceSize = 0;
            ...
            bool ifNewRoot = (templateDataParams.subRoot == mySubCommRank_);
            ...
            std::unique_ptr<hcomm::CcuTaskArg> taskArg = std::make_unique<CcuTaskArgGatherOmniPipeNHR1DMem2Mem>(
                ...
                templateDataParams.isStepOne_, 
                templateDataParams.isLastStep_, 
                ifNewRoot,
            ...
            HCCL_DEBUG("[CcuTempGatherOmniPipeNHR1DMem2Mem::KernelRun] sliceSize=%llu  inputOmniPipeSliceStride=%llu outputOmniPipeSliceStride=%llu isStepOne_[%d] isLastStep_[%d] ",
                        sliceSize, inputOmniPipeSliceStride,outputOmniPipeSliceStride, templateDataParams.isStepOne_,templateDataParams.isLastStep_);
            }
        }
    }
