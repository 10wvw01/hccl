...
class CcuKernelArgGatherOmniPipeMesh1DMem2MemY : public CcuKernelArg {
public:
...
class CcuTaskArgGatherOmniPipeMesh1DMem2MemY : public CcuTaskArg {
public:
    explicit CcuTaskArgGatherOmniPipeMesh1DMem2MemY(uint64_t inputAddr, uint64_t outputAddr, uint64_t token, 
...
struct GatherOmniPipeMesh1DMem2MemYContext {
