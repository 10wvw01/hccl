...
static CcuResult InitResource(GatherOmniPipeMesh1DMem2MemContext &ctx)
{
    ...
    if (arg->channelCount == 0) {
        HCCL_ERROR("[CcuGatherOmniPipeMesh1DMem2Mem] channels is empty!");
        return CCU_E_INTERNAL;
    }
    
    HCCL_INFO("[CcuGatherOmniPipeMesh1DMem2Mem] channels.size: [%u]", arg->channelCount);
...
CcuResult CcuGatherOmniPipeMesh1DMem2MemKernel(CcuKernelArg arg)
{
    ...
    HCCL_INFO("[CcuGatherOmniPipeMesh1DMem2Mem] GatherOmniPipeMesh1DMem2Mem end");
