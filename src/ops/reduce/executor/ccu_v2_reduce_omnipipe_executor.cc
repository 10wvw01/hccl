    ...
    std::vector<double> &endpointAttrBwAvgG)
{
    ...
    HCCL_DEBUG("[%s] rankId[%d], bwXSC[%f]", __func__, myRank_, rXRS);
    HCCL_DEBUG("[%s] rankId[%d], bwYSC[%f]", __func__, myRank_, rYRS);
    HCCL_DEBUG("[%s] rankId[%d], bwXAG[%f]", __func__, myRank_, rXG);
    HCCL_DEBUG("[%s] rankId[%d], bwYAG[%f]", __func__, myRank_, rYG);
