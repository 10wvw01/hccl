        ...
        u32 loopTimes, u64 maxCountPerLoop)
{
    ...
    while ((isAicpuTs && processedCount < dataCount_) || (!isAicpuTs && loopIndex < loopTimes)) {
        ...
        if (isAicpuTs) {
            ...
            currProcessedCount = currCountPart0 + currCountPart1;
        } else {
            currCount = (loopIndex + 1 == loopTimes) ? (dataCount_ - loopIndex * maxCountPerLoop) : maxCountPerLoop;
