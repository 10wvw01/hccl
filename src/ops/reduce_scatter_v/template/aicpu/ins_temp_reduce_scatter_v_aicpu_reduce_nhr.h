...
#ifndef INS_TEMP_REDUCE_SCATTER_V_AICPU_REDUCE_NHR_H
#define INS_TEMP_REDUCE_SCATTER_V_AICPU_REDUCE_NHR_H
...
class InsTempReduceScatterVAicpuReduceNHR : public InsAlgTemplateBase {
public:
    InsTempReduceScatterVAicpuReduceNHR() = default;
    explicit InsTempReduceScatterVAicpuReduceNHR(const OpParam& param, const u32 rankId,
                                     const std::vector<std::vector<u32>> &subCommRanks);
    ~InsTempReduceScatterVAicpuReduceNHR() override;

    std::string Describe() const override
    {
        std::string info = "Template of reduce scatter v AicpuReduceNHR with tempRankSize ";
...
#endif // INS_TEMP_REDUCE_SCATTER_V_AICPU_REDUCE_NHR_H
