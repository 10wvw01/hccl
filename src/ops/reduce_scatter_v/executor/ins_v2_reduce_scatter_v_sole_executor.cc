...
REGISTER_EXEC_V2(HcclCMDType::HCCL_CMD_REDUCE_SCATTER_V, InsReduceScatterVAicpuReduceNHR, InsV2ReduceScatterVSoleExecutor, TopoMatch1D,
    InsTempReduceScatterVAicpuReduceNHR);
