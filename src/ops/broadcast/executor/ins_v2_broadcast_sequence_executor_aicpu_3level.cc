    ...
    InsAlgTemplate3, InsAlgTemplate4, InsAlgTemplate5>::OrchestrateLoop(const OpParam &param, const AlgResourceCtxSerializable &resCtx)
{
    ...
    auto FillSliceScalars = [&](TemplateDataParams &p, u64 count, u64 rankSize) {
        u64 perRankCount = (count + rankSize - 1) / rankSize;
        u64 perRankSize = perRankCount * dataTypeSize_;
        u64 lastRankCount = count - perRankCount * (rankSize - 1);
        u64 lastRankSize = lastRankCount * dataTypeSize_;
        p.sliceSize = perRankSize;
        p.tailSize = (perRankSize != lastRankSize) ? lastRankSize : 0;
        p.inputSliceStride = perRankSize;
        p.outputSliceStride = perRankSize;
    };
    // scatter L0
    ...
    for (u64 loop = 0; loop < loopTimes; loop++) {
        ...
        FillSliceScalars(tempAlgParamsScatterL0, currDataCount, rankSizeLevel0_);
        ...
        FillSliceScalars(tempAlgParamsScatterL1, tempAlgParamsScatterL1.count, rankSizeLevel1_);
        ...
        FillSliceScalars(tempAlgParamsScatterL2, tempAlgParamsScatterL2.count, rankSizeLevel2_);
        ...
        FillSliceScalars(tempAlgParamsAllGatherL2, tempAlgParamsAllGatherL2.count, rankSizeLevel2_);
        ...
        FillSliceScalars(tempAlgParamsAllGatherL1, tempAlgParamsAllGatherL1.count, rankSizeLevel1_);
        ...
        FillSliceScalars(tempAlgParamsAllGatherL0, currDataCount, rankSizeLevel0_);
