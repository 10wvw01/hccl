    ...
    InsAlgTemplate3, InsAlgTemplate4, InsAlgTemplate5>::OrchestrateLoop(const OpParam &param, const AlgResourceCtxSerializable &resCtx)
{
    ...
    CHK_RET(GenTempResource(resCtx, 0, algTemplateLevel0, templateResourceL0));
    // 构造L1 template资源
    ...
    CHK_RET(GenTempResource(resCtx, 0, algTemplateLevel0, templateResourceL1));
    ...
    CHK_RET(GenTempResource(resCtx, 0, algTemplateLevel0, templateResourceL2));
