...
#ifndef HCCLV2_CCU_V2_BROADCAST_OMNIPIPE_EXECUTOR_H
#define HCCLV2_CCU_V2_BROADCAST_OMNIPIPE_EXECUTOR_H
...
class CcuV2BroadcastOmniPipeExecutor : public InsCollAlgBase {
public:
    explicit CcuV2BroadcastOmniPipeExecutor();
    ~CcuV2BroadcastOmniPipeExecutor() = default;
...
private:
    ...
    std::vector<u32> ntfIdxCtrlToTempLevel01RS_; // TODO
    std::vector<u32> ntfIdxTempToCtrlLevel01RS_; // TODO
