            ...
            const OpParam& param, const AlgResourceCtxSerializable& resCtx)
{
    ...
    for (u64 loop = 0; loop < loopTimes; loop++) {
        ...
        if (myRank_ != param.root) {                        
            ...
            tempAlgParamLocalCopy.buffInfo.inBuffBaseOff = myRank_ * allRankSplitData[0] * dataTypeSize_ + processedDataCount * dataTypeSize_; // TODO 从这个地方考虑 ccubuffer切分多块
            tempAlgParamLocalCopy.buffInfo.outBuffBaseOff = myRank_ * allRankSplitData[0] * dataTypeSize_ + processedDataCount * dataTypeSize_; // TODO 检查下
