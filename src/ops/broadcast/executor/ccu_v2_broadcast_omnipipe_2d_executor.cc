            ...
            const OpParam& param, const AlgResourceCtxSerializable& resCtx)
{
    ...
    // }
        ...
        if (myRank_ != param.root) { // TODO 这块的搬运细节需要验证下                        
            ...
            tempAlgParamLocalCopy.buffInfo.outBuffBaseOff = myRank_ * perLoopSize + processedDataCount * dataTypeSize_;
            ...
            tempAlgParamLocalCopy.buffInfo.inBuffBaseOff =  myRank_ * perLoopSize; // TODO 从这个地方考虑 ccubuffer切分多块  》myRank_ * allRankSplitData[0] * dataTypeSize_ + 
