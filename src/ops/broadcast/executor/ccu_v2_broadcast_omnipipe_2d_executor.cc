            ...
            const OpParam& param, const AlgResourceCtxSerializable& resCtx)
{
    ...
    u64 maxCountPerLoop = std::max(transportBoundDataSize, maxTmpMemSize_) / HCCL_MIN_SLICE_ALIGN
                          * HCCL_MIN_SLICE_ALIGN / dataTypeSize_ / rankSize_; // TODO：优化下，分别计算每张卡 两个值的大小，再取最小值
