...
class InsV2BroadcastSequenceExecutorAicpu3Level : public InsCollAlgBase {
public:
    explicit InsV2BroadcastSequenceExecutorAicpu3Level();
    ~InsV2BroadcastSequenceExecutorAicpu3Level() = default;
...
protected:
    ...
    // 三层AllGather标量分片生成
    void GenTempAlgParamsAGL2(u64 ag2Cnt, u64 l0SliceByte, u64 l1SliceByte, TemplateDataParams &params) const;
    void GenTempAlgParamsAGL1(u64 ag1Cnt, u64 l0SliceByte, TemplateDataParams &params) const;
    void GenTempAlgParamsAGL0(u64 currDataCount, u64 processedDataCount, TemplateDataParams &params) const;
