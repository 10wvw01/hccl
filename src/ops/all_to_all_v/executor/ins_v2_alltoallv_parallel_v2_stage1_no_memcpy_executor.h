...
#ifndef HCCLV2_INS_V2_ALLTOALLV_PARALLEL_V2_STAGE1_NO_MEMCPY_EXECUTOR_H
#define HCCLV2_INS_V2_ALLTOALLV_PARALLEL_V2_STAGE1_NO_MEMCPY_EXECUTOR_H
...
class InsV2AlltoAllVParallelV2Stage1NoMemcpyExecutor : public InsCollAlgBase {
public:
    explicit InsV2AlltoAllVParallelV2Stage1NoMemcpyExecutor() = default;
    ~InsV2AlltoAllVParallelV2Stage1NoMemcpyExecutor() override = default;
...
#endif // HCCLV2_INS_V2_ALLTOALLV_PARALLEL_V2_STAGE1_NO_MEMCPY_EXECUTOR_H
