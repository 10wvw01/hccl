...
private:
    ...
    bool IsNoMemcpyMode(const TemplateDataParams &tempAlgParams) const;
    HcclResult CheckNoMemcpyPeerInfo(const TemplateDataParams &tempAlgParams, u32 remoteRank, u64 txCount) const;
