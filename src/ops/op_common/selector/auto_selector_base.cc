...
bool AutoSelectorBase::IsLayerAllConnectedWithTopo(const TopoInfoWithNetLayerDetails *topoInfo, const u32 netLayer, const CommTopo topoType) const
{
    return IsAllConnectedWithTopo(topoInfo, netLayer, topoType);
}
