    ...
    ThreadHandle exportedCpuTsThread, u32 notifyNumOnMainThread, void *resCtxSequence, std::string &algName, ThreadHandle unfoldThread)
{
    ...
    if (isCapture) {
        ...
        // TODO：考虑其他参数
        HcclOpbaseLaunchInOrderToOrderStream(comm, param, unfoldThread, notifyIdx, execTimeout);
    } else if (param.opMode == OpMode::OFFLOAD) {
        // TODO：考虑其他参数
        // HcclHcommLaunchInOrderToOrderStream(comm, param, unfoldThread, );
    }
    /*************************/
    ...
    if (isCapture) {
        ...
        // HcclAclgraphLaunchInOrderToKernelStream(comm, param, unfoldThread, );
    } else if (param.opMode == OpMode::OPBASE) {
        // TODO：考虑其他参数
        HcclOpbaseLaunchInOrderToKernelStream(comm, param, unfoldThread, notifyIdx, execTimeout);
    } else if (param.opMode == OpMode::OFFLOAD) {
        // TODO：考虑其他参数
        // HcclHcommLaunchInOrderToKernelStream(comm, param, unfoldThread, );
    }
    /**************************/
