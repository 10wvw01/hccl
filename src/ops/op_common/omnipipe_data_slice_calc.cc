                                  ...
                                  u64 xRankSize, u64 yRankSize, u64 zRankSize, u64 dataSize, int maxStepNum)
{
    ...
    if (zB > xyB) {
        ...
        HCCL_INFO("[CalcScatterOuterStepNum] zB>xyB,outerStepNum=[%u]", outerStepNum);
    } else {
        outerStepNum = CalScatterDataSize2D(
                                  ...
                                  u64 xRankSize, u64 yRankSize, int outerStepNum, int maxStepNum)
{
    ...
    if (yB >= xB) {
        for (u64 i = 0; i < (u64)outerStepNum; i++) {
            ...
            HCCL_INFO("[CalcScatterInnerStepNum] innerStepNum=[%u]", innerStepNum);
        }
    } else {
        for (u64 i = 0; i < (u64)outerStepNum; i++) {
            innerStepNum = CalScatterDataSize2D(
                                   ...
                                   double &bufferRatio, std::vector<u64> &scratchInfo)
{
    ...
    HCCL_INFO("[CalcScatterBufferRatio] "
              "maxTmpMemSize=0,allCclBufferSize!=0,allCclBufferSize=[%u]",
        allCclBufferSize);
    return false;
}
