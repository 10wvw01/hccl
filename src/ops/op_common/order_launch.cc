 ...
 * 执行流程：
 */
HcclResult HcclOpbaseLaunchInOrderToKernelStream(HcclComm comm, OpParam &param, ThreadHandle unfoldThread, u32 notifyIdx, u32 timeout)
{
 ...
 * 执行流程：
 */
HcclResult HcclAclgraphLaunchInOrderToKernelStream(HcclComm comm, OpParam &param, ThreadHandle unfoldThread, u32 notifyIdx, u32 timeout, HcclRtEvent event)
{
 ...
 * 执行流程：
 */
HcclResult HcclHcommLaunchInOrderToKernelStream(HcclComm comm, OpParam &param, ThreadHandle unfoldThread, u32 graphId, u32 notifyIdx, u32 timeout)
{
