...
static unsigned int HcclLaunchAicpuKernelInternal(OpParam *param)
{
    FUNCTION_TRACE;
...
extern "C" unsigned int HcclLaunchAicpuKernel(OpParam *param)
{
    ...
    const unsigned int result = HcclLaunchAicpuKernelInternal(param);

    constexpr uint64_t dumpOpCnt = 30;
    if (opUnfoldIdx == dumpOpCnt) {
