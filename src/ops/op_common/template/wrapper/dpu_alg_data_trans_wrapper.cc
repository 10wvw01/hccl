...
HcclResult SendRecvWrite(const SendRecvInfo &sendRecvInfo, void *taskexpShmem)
{
    ...
    CHK_RET_AND_TASKEXCEPTION(<HcclResult>(HcommChannelNotifyRecordOnThread(0, recvChannel.handle, NOTIFY_IDX_ACK)), taskexpShmem, recvChannel);
    //CHK_RET(static_cast<HcclResult>(HcommChannelNotifyRecordOnThread(0, recvChannel.handle, NOTIFY_IDX_ACK)));
    CHK_RET_AND_TASKEXCEPTION(static_cast<HcclResult>(HcommChannelNotifyWaitOnThread(0, sendChannel.handle, NOTIFY_IDX_ACK, DPU_TIMEOUT)), taskexpShmem, sendChannel);
    ...
    for (int i = 0; i < repeatNum; i++) {
        ...
        CHK_RET_AND_TASKEXCEPTION(static_cast<HcclResult>(
    ...
    // 写完之后做后同步告诉对面写完了
    CHK_RET_AND_TASKEXCEPTION(static_cast<HcclResult>(HcommChannelNotifyRecordOnThread(0, sendChannel.handle, NOTIFY_IDX_FIN_ACK)), taskexpShmem, sendChannel);
    //CHK_RET(static_cast<HcclResult>(HcommChannelNotifyRecordOnThread(0, sendChannel.handle, NOTIFY_IDX_FIN_ACK)));
    CHK_RET_AND_TASKEXCEPTION(static_cast<HcclResult>(HcommChannelNotifyWaitOnThread(0, recvChannel.handle, NOTIFY_IDX_FIN_ACK, DPU_TIMEOUT)), taskexpShmem, recvChannel);
    //CHK_RET(static_cast<HcclResult>(HcommChannelNotifyWaitOnThread(0, recvChannel.handle, NOTIFY_IDX_FIN_ACK, DPU_TIMEOUT)));
    CHK_RET_AND_TASKEXCEPTION(static_cast<HcclResult>(HcommChannelFenceOnThread(0, sendChannel.handle)), taskexpShmem, sendChannel);
...
HcclResult SendWrite(const DataInfo &sendInfo, void *taskexpShmem)
{
#ifndef AICPU_COMPILE
    ...
    CHK_RET_AND_TASKEXCEPTION(static_cast<HcclResult>(HcommChannelNotifyRecordOnThread(0, sendChannel.handle, NOTIFY_IDX_ACK)), taskexpShmem, sendChannel);
    ...
    for (int i = 0; i < sliceNum; i++) {
        ...
        //CHK_RET(static_cast<HcclResult>(
        //    HcommWriteWithNotifyNbiOnThread(0, sendChannel.handle, dst, src, srcSlice.size_, NOTIFY_IDX_DATA_SIGNAL)));
        CHK_RET_AND_TASKEXCEPTION(static_cast<HcclResult>(HcommChannelNotifyWaitOnThread(0, sendChannel.handle, NOTIFY_IDX_DATA_SIGNAL, DPU_TIMEOUT)), taskexpShmem, sendChannel);
        //CHK_RET(static_cast<HcclResult>(HcommChannelNotifyWaitOnThread(0, sendChannel.handle, NOTIFY_IDX_DATA_SIGNAL, DPU_TIMEOUT)));
    }
    CHK_RET_AND_TASKEXCEPTION(static_cast<HcclResult>(HcommChannelNotifyRecordOnThread(0, sendChannel.handle, NOTIFY_IDX_FIN_ACK)), taskexpShmem, sendChannel);
    //CHK_RET(static_cast<HcclResult>(HcommChannelNotifyRecordOnThread(0, sendChannel.handle, NOTIFY_IDX_FIN_ACK)));
    CHK_RET_AND_TASKEXCEPTION(static_cast<HcclResult>(HcommChannelNotifyWaitOnThread(0, sendChannel.handle, NOTIFY_IDX_FIN_ACK, DPU_TIMEOUT)), taskexpShmem, sendChannel);
...
HcclResult RecvWrite(const DataInfo &recvInfo, void *taskexpShmem)
{
#ifndef AICPU_COMPILE
    ...
    u32 sliceNum = srcSlices.size();
    CHK_RET_AND_TASKEXCEPTION(static_cast<HcclResult>(HcommChannelNotifyRecordOnThread(0, recvChannel.handle, NOTIFY_IDX_ACK)), taskexpShmem, recvChannel);
    //CHK_RET(static_cast<HcclResult>(HcommChannelNotifyRecordOnThread(0, recvChannel.handle, NOTIFY_IDX_ACK)));
    CHK_RET_AND_TASKEXCEPTION(static_cast<HcclResult>(HcommChannelNotifyWaitOnThread(0, recvChannel.handle, NOTIFY_IDX_ACK, DPU_TIMEOUT)), taskexpShmem, recvChannel);
    //CHK_RET(static_cast<HcclResult>(HcommChannelNotifyWaitOnThread(0, recvChannel.handle, NOTIFY_IDX_ACK, DPU_TIMEOUT)));
    for (int i = 0; i < sliceNum; i++) {
        CHK_RET_AND_TASKEXCEPTION(static_cast<HcclResult>(HcommChannelNotifyRecordOnThread(0, recvChannel.handle, NOTIFY_IDX_DATA_SIGNAL)), taskexpShmem, recvChannel);
    ...
    CHK_RET_AND_TASKEXCEPTION(static_cast<HcclResult>(HcommChannelNotifyRecordOnThread(0, recvChannel.handle, NOTIFY_IDX_FIN_ACK)), taskexpShmem, recvChannel);
    //CHK_RET(static_cast<HcclResult>(HcommChannelNotifyRecordOnThread(0, recvChannel.handle, NOTIFY_IDX_FIN_ACK)));
    CHK_RET_AND_TASKEXCEPTION(static_cast<HcclResult>(HcommChannelNotifyWaitOnThread(0, recvChannel.handle, NOTIFY_IDX_FIN_ACK, DPU_TIMEOUT)), taskexpShmem, recvChannel);
    //CHK_RET(static_cast<HcclResult>(HcommChannelNotifyWaitOnThread(0, recvChannel.handle, NOTIFY_IDX_FIN_ACK, DPU_TIMEOUT)));
    CHK_RET_AND_TASKEXCEPTION(static_cast<HcclResult>(HcommChannelFenceOnThread(0, recvChannel.handle)), taskexpShmem, recvChannel);
