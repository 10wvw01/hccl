...
HcclResult SendRecvWrite(const SendRecvInfo &sendRecvInfo, void *taskexpShmem)
{
    ...
    CHK_RET(ChkRetAndTaskexception(static_cast<HcclResult>(1), taskexpShmem, recvChannel)); // 打桩构造错误
    ChkRetAndTaskexception(static_cast<HcclResult>(HcommChannelNotifyRecordOnThread(0, recvChannel.handle, NOTIFY_IDX_ACK)), taskexpShmem, recvChannel);
    ...
    for (int i = 0; i < repeatNum; i++) {
        ...
        ChkRetAndTaskexception(static_cast<HcclResult>(
    ...
    // 写完之后做后同步告诉对面写完了
    ChkRetAndTaskexception(static_cast<HcclResult>(HcommChannelNotifyRecordOnThread(0, sendChannel.handle, NOTIFY_IDX_FIN_ACK)), taskexpShmem, sendChannel);
    //CHK_RET(static_cast<HcclResult>(HcommChannelNotifyRecordOnThread(0, sendChannel.handle, NOTIFY_IDX_FIN_ACK)));
    ChkRetAndTaskexception(static_cast<HcclResult>(HcommChannelNotifyWaitOnThread(0, recvChannel.handle, NOTIFY_IDX_FIN_ACK, DPU_TIMEOUT)), taskexpShmem, recvChannel);
    //CHK_RET(static_cast<HcclResult>(HcommChannelNotifyWaitOnThread(0, recvChannel.handle, NOTIFY_IDX_FIN_ACK, DPU_TIMEOUT)));
    ChkRetAndTaskexception(static_cast<HcclResult>(HcommChannelFenceOnThread(0, sendChannel.handle)), taskexpShmem, sendChannel);
...
HcclResult SendWrite(const DataInfo &sendInfo, void *taskexpShmem)
{
    ...
    ChkRetAndTaskexception(static_cast<HcclResult>(HcommChannelNotifyRecordOnThread(0, sendChannel.handle, NOTIFY_IDX_ACK)), taskexpShmem, sendChannel);
    //CHK_RET(static_cast<HcclResult>(HcommChannelNotifyRecordOnThread(0, sendChannel.handle, NOTIFY_IDX_ACK)));
    ChkRetAndTaskexception(static_cast<HcclResult>(HcommChannelNotifyWaitOnThread(0, sendChannel.handle, NOTIFY_IDX_ACK, DPU_TIMEOUT)), taskexpShmem, sendChannel);
    //CHK_RET(static_cast<HcclResult>(HcommChannelNotifyWaitOnThread(0, sendChannel.handle, NOTIFY_IDX_ACK, DPU_TIMEOUT)));
    for (int i = 0; i < sliceNum; i++) {
        ...
        //CHK_RET(static_cast<HcclResult>(
        //    HcommWriteWithNotifyNbiOnThread(0, sendChannel.handle, dst, src, srcSlice.size_, NOTIFY_IDX_DATA_SIGNAL)));
        ChkRetAndTaskexception(static_cast<HcclResult>(HcommChannelNotifyWaitOnThread(0, sendChannel.handle, NOTIFY_IDX_DATA_SIGNAL, DPU_TIMEOUT)), taskexpShmem, sendChannel);
        //CHK_RET(static_cast<HcclResult>(HcommChannelNotifyWaitOnThread(0, sendChannel.handle, NOTIFY_IDX_DATA_SIGNAL, DPU_TIMEOUT)));
    }
    ChkRetAndTaskexception(static_cast<HcclResult>(HcommChannelNotifyRecordOnThread(0, sendChannel.handle, NOTIFY_IDX_FIN_ACK)), taskexpShmem, sendChannel);
    //CHK_RET(static_cast<HcclResult>(HcommChannelNotifyRecordOnThread(0, sendChannel.handle, NOTIFY_IDX_FIN_ACK)));
    ChkRetAndTaskexception(static_cast<HcclResult>(HcommChannelNotifyWaitOnThread(0, sendChannel.handle, NOTIFY_IDX_FIN_ACK, DPU_TIMEOUT)), taskexpShmem, sendChannel);
...
HcclResult RecvWrite(const DataInfo &recvInfo, void *taskexpShmem)
{
    ...
    ChkRetAndTaskexception(static_cast<HcclResult>(HcommChannelNotifyRecordOnThread(0, recvChannel.handle, NOTIFY_IDX_ACK)), taskexpShmem, recvChannel);
    //CHK_RET(static_cast<HcclResult>(HcommChannelNotifyRecordOnThread(0, recvChannel.handle, NOTIFY_IDX_ACK)));
    ChkRetAndTaskexception(static_cast<HcclResult>(HcommChannelNotifyWaitOnThread(0, recvChannel.handle, NOTIFY_IDX_ACK, DPU_TIMEOUT)), taskexpShmem, recvChannel);
    //CHK_RET(static_cast<HcclResult>(HcommChannelNotifyWaitOnThread(0, recvChannel.handle, NOTIFY_IDX_ACK, DPU_TIMEOUT)));
    for (int i = 0; i < sliceNum; i++) {
        ChkRetAndTaskexception(static_cast<HcclResult>(HcommChannelNotifyRecordOnThread(0, recvChannel.handle, NOTIFY_IDX_DATA_SIGNAL)), taskexpShmem, recvChannel);
    ...
    ChkRetAndTaskexception(static_cast<HcclResult>(HcommChannelNotifyRecordOnThread(0, recvChannel.handle, NOTIFY_IDX_FIN_ACK)), taskexpShmem, recvChannel);
    //CHK_RET(static_cast<HcclResult>(HcommChannelNotifyRecordOnThread(0, recvChannel.handle, NOTIFY_IDX_FIN_ACK)));
    ChkRetAndTaskexception(static_cast<HcclResult>(HcommChannelNotifyWaitOnThread(0, recvChannel.handle, NOTIFY_IDX_FIN_ACK, DPU_TIMEOUT)), taskexpShmem, recvChannel);
    //CHK_RET(static_cast<HcclResult>(HcommChannelNotifyWaitOnThread(0, recvChannel.handle, NOTIFY_IDX_FIN_ACK, DPU_TIMEOUT)));
    ChkRetAndTaskexception(static_cast<HcclResult>(HcommChannelFenceOnThread(0, recvChannel.handle)), taskexpShmem, recvChannel);
