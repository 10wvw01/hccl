...
#ifndef INS_TEMP_REDUCE_SCATTER_MESH_1D_OCS_SPARSE_H
#define INS_TEMP_REDUCE_SCATTER_MESH_1D_OCS_SPARSE_H
...
class InsTempReduceScatterMesh1DOcsSparse : public InsTempReduceScatterMesh1D {
public:
    InsTempReduceScatterMesh1DOcsSparse() = default;
    explicit InsTempReduceScatterMesh1DOcsSparse(const OpParam& param, const u32 rankId,
                                           const std::vector<std::vector<u32>> &subCommRanks);

    ~InsTempReduceScatterMesh1DOcsSparse() override;

    std::string Describe() const override
    {
        std::string info = "Template of reduce scatter Mesh 1D OCS sparse with tempRankSize ";
    ...
    void SetMultiLevelRankSize(u32 rankSize);
