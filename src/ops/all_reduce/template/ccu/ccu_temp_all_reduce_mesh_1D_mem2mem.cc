...
std::vector<CostModelParam> CcuTempAllReduceMeshMem2Mem1D::CalcCostCoeff(u32 rankSize)
{
    // 和twoshot相同
    ...
    CostModelManager::CalcLocalCopyParams(n, 1, B1);
    CostModelManager::CalcLocalReduceParams(n * (rankSize - 1), 1, B2);
    B = B1 + B2;
