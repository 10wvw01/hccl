...
HcclResult CcuTempAllReduceMeshMem2Mem1D::CalcSlice(const u64 dataSize, RankSliceInfo &sliceInfoVec)
{
    ...
    u64 chunkSize      = RoundUp(dataSize, (templateRankSize_ * unitAlignSize)) * unitAlignSize;
    HCCL_INFO("[CcuTempAllReduceMeshMem2Mem1D] chunkSize[%llu], dataSize[%llu], templateRankSize_[%u], unitAlignSize[%llu]",
              chunkSize, dataSize, templateRankSize_, unitAlignSize);
    u64 accumOff = 0;
