...
std::vector<CostModelParam> CcuTempAllReduceMesh1DOneShot::CalcCostCoeff(u32 rankSize)
{
    ...
    CostModelManager::Global()->CalcMeshParam(1, netType, portNum, A);
    CostModelManager::Global()->CalcLocalReduceParams(rankSize - 1, 1, B);
...
AlgNetType CcuTempAllReduceMesh1DOneShot::GetNetType()
{
