...
std::vector<CostModelParam> InsTempAllReduceNHR::CalcCostCoeff(u32 rankSize)
{
    ...
    CostModelManager::Global()->CalcNHRParams((rankSize - 1) * n * 2, netType, portNum, A);
    CostModelManager::Global()->CalcLocalCopyParams(n , 0, B);
...
AlgNetType InsTempAllReduceNHR::GetNetType()
{
