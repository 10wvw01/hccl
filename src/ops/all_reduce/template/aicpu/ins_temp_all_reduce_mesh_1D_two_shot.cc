...
std::vector<CostModelParam> InsTempAllReduceMesh1DTwoShot::CalcCostCoeff(u32 rankSize)
{
    (void)rankSize;
    HCCL_DEBUG("[InsTempAllReduceMesh1DTwoShot] CalcCostCoeff.");
    float n = 1.0f;
    int netType = 0;
    int portNum = 0;
    int taskNum = 1;
...
AlgNetType InsTempAllReduceMesh1DTwoShot::GetNetType()
{
