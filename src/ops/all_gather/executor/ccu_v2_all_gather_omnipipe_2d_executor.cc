...
HcclResult CcuV2AllGatherOmniPipe2DExecutor<AlgTopoMatch, InsAlgTempLevel0, InsAlgTempLevel1>::InitCommInfo(
    ...
    AlgResourceRequest& resourceRequest)
{
    ...
    // 重复的template构造
    CcuAlgTempLevel0 algTempLevel0(param, myRank_, subCommRanks0_);
    CcuAlgTempLevel1 algTempLevel1(param, myRank_, subCommRanks1_);
    ...
    const OpParam &param, const AlgResourceCtxSerializable &resCtx)
{
    ...
    // 1. 计算带宽
    std::vector<double> endpointAttrBw = {1.0, 1.0, 1.0};
    ...
    sliceParam.endpointAttrBw = endpointAttrBw;//{1.0,1.0,1.0}
...
REGISTER_EXECUTOR_BY_TWO_TEMPS(HcclCMDType::HCCL_CMD_ALLGATHER, CcuAllGatherOmniPipe2D,
    CcuV2AllGatherOmniPipe2DExecutor, TopoMatchUBX, CcuTempAllGatherOmniPipeMesh1DMem2Mem, CcuTempAllGatherOmniPipeNHR1DMem2Mem);
