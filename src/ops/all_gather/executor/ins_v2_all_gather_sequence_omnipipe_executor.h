...
#ifndef HCCLV2_INS_V2_ALL_GATHER_SEQUENCE_OMNIPIPE_EXECUTOR_H
#define HCCLV2_INS_V2_ALL_GATHER_SEQUENCE_OMNIPIPE_EXECUTOR_H
...
class InsV2AllGatherSequenceOmniPipeExecutor : public InsCollAlgBase {
public:
    explicit InsV2AllGatherSequenceOmniPipeExecutor();
    ~InsV2AllGatherSequenceOmniPipeExecutor() override = default;
    /* *************** 资源计算 *************** */
...
private:
    ...
    std::vector<std::vector<u32>> subCommRanks2ForZ_;
};
}
#endif
