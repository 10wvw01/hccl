...
#ifndef INS_TEMP_ALL_GATHER_NHR_DPU_NO_LOCALCOPY_H
#define INS_TEMP_ALL_GATHER_NHR_DPU_NO_LOCALCOPY_H
...
namespace ops_hccl {
class InsTempAllGatherNHRDPUNoLocalCopy : public InsAlgTemplateBase {
public:
    InsTempAllGatherNHRDPUNoLocalCopy() {}
    InsTempAllGatherNHRDPUNoLocalCopy(const OpParam& param, const u32 rankId,
                           const std::vector<std::vector<u32>> &subCommRanks);

    ~InsTempAllGatherNHRDPUNoLocalCopy() override {}

    std::string Describe() const override
    {
        std::string info = "Template of AllGather NHR NoLocalCopy with tempRankSize ";
