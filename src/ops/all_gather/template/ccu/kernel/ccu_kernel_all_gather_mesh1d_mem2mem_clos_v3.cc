...
static CcuResult DoAllGather(AllGatherMesh1DMem2MemClosV3Context &ctx, const ccu::LocalAddr &src, const std::vector<ccu::RemoteAddr> &dst, const ccu::Variable &sliceSize)
{
    const auto *arg = ctx.arg;
