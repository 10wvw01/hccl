...
class CcuKernelArgAllGatherOmniPipeMesh1DMem2Mem : public CcuKernelArg {
public:
    explicit CcuKernelArgAllGatherOmniPipeMesh1DMem2Mem(uint64_t dimSize, uint32_t rankId, const OpParam& opParam,
    ...
    {
        HCCL_DEBUG("[CcuKernelArgAllGatherOmniPipeMesh1DMem2Mem] dimSize: %lu, rankId: %u, reduceOp: %d, dataType: %d",
...
class CcuTaskArgAllGatherOmniPipeMesh1DMem2Mem : public CcuTaskArg {
public:
...
public:
    CcuKernelAllGatherOmniPipeMesh1DMem2Mem(const hcomm::CcuKernelArg &arg);
    ~CcuKernelAllGatherOmniPipeMesh1DMem2Mem() override {}
