...
HcclResult InsTempScatterNHRDPUInterNode::LocalDataCopy(const TemplateDataParams& tempAlgParams,
    const TemplateResource& templateResource)
{
    ...
    for (uint64_t rpt = 0; rpt < tempAlgParams.repeatNum; ++rpt) {
        ...
        HCCL_INFO("[InsTempScatterNHRDPUInterNode][LocalCopy] LocalDataCopy RankID [%d] algRankIdx [%d] "
    ...
    const TemplateResource& templateResource)
{
    ...
    for (u32 rpt = 0; rpt < tempAlgParams.repeatNum; ++rpt) {
        ...
        for (auto rank : subCommRanks_[0]) {
            ...
            HCCL_INFO("[InsTempScatterNHRDPUInterNode][LocalCopy] LocalDataCopy RankID [%d] dataRank [%d] dataAlgRank[%d] "
