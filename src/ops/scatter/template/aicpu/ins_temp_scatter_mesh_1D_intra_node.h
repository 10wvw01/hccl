...
#ifndef INS_TEMP_SCATTER_MESH_1D_INTRA_NODE_H
#define INS_TEMP_SCATTER_MESH_1D_INTRA_NODE_H
...
class InsTempScatterMesh1DIntraNode : public InsAlgTemplateBase {
public:
    InsTempScatterMesh1DIntraNode() = default;
    explicit InsTempScatterMesh1DIntraNode(const OpParam& param, const u32 rankId, // 传通信域的rankId，userRank
                                const std::vector<std::vector<u32>> &subCommRanks);
    ~InsTempScatterMesh1DIntraNode() override;
...
#endif //OPEN_HCCL_INS_TEMP_SCATTER_MESH_1D_INTRA_NODE_H