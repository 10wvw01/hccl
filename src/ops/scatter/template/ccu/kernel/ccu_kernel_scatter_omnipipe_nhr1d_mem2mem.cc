    ...
    const NHRStepInfo &nhrStepInfo)
{
    ...
    HCCL_DEBUG("myrealrank[%u] sendSliceIdxList.size() = %u", ctx.myrealrank, sendSliceIdxList.size());
    HCCL_DEBUG("myrealrank[%u] recvSliceIdxList.size() = %u", ctx.myrealrank, recvSliceIdxList.size());
