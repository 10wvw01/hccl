...
#ifndef HCCLV2_INS_V2_SCATTER_SEQUENCE_EXECUTOR_3LEVEL_H
#define HCCLV2_INS_V2_SCATTER_SEQUENCE_EXECUTOR_3LEVEL_H
...
class InsV2ScatterSequenceExecutor3Level : public InsCollAlgBase {
public:
    explicit InsV2ScatterSequenceExecutor3Level();
    ~InsV2ScatterSequenceExecutor3Level() override = default;
