    ...
    const OpParam &param, const AlgResourceCtxSerializable& resCtx)
{
    ...
    if (!skipLevel2_) {
        ...
        algTemplateLevel2->SetRoot((param.root / (rankSizeLevel0_ * rankSizeLevel1_)) * (rankSizeLevel0_ * rankSizeLevel1_)
    ...
    u64 maxCountPerLoop = tempAlgParamsLevel0.buffInfo.hcclBuff.size / templateScratchMultiplier / HCCL_MIN_SLICE_ALIGN
