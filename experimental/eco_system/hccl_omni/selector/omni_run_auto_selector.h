...
#ifndef HCCLV2_OMNI_RUN_AUTO_SELECTOR_H
#define HCCLV2_OMNI_RUN_AUTO_SELECTOR_H

#include "auto_selector_base.h"

namespace ops_hccl {

class OmniRunAutoSelector : public AutoSelectorBase {
private:
    ...
    bool IsOmniRunOp(const OpParam &opParam) const;
};
