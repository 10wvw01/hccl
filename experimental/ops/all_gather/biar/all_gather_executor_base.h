...
#ifndef ALL_GATHER_EXECUTOR_H
#define ALL_GATHER_EXECUTOR_H
...
class AllGatherExecutorBase : public ExecutorBase {
public:
    explicit AllGatherExecutorBase();
    ~AllGatherExecutorBase() override = default;
