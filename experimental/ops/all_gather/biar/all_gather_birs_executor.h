...
#ifndef ALL_GATHER_BIRS_EXECUTOR_H
#define ALL_GATHER_BIRS_EXECUTOR_H
...
class AllGatherBIRSExecutor : public AllGatherExecutorBase {
public:
    explicit AllGatherBIRSExecutor();
    ~AllGatherBIRSExecutor() override = default;
