...
#ifndef ALL_GATHER_MESH_EXECUTOR_H
#define ALL_GATHER_MESH_EXECUTOR_H
...
class AllGatherMeshExecutor : public AllGatherExecutorBase {
public:
    explicit AllGatherMeshExecutor();
    ~AllGatherMeshExecutor() override = default;
...
private:
    HcclResult SelectAndPrepareTemplate(bool isSingleServer, u32 localRank, u32 localRankSize, std::unique_ptr<AlgTemplateBase>& templatePtr);
