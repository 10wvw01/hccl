...
#ifndef ALL_GATHER_BIRS_H
#define ALL_GATHER_BIRS_H
...
class AllGatherBIRS : public AlgTemplateBaseExperimental {
public:
    explicit AllGatherBIRS();

    ~AllGatherBIRS() override;  

    // should be called soon after template AllGatherBIRS instance created
...
protected:
    ...
    HcclResult LocalCopyMainLoop(u32 round, const u32 rank, const u32 rankSize, u32 rankSizeX_,
                            u64 sliceSize, u64 localStrideSize);
    HcclResult FinalStep(const u32 rank, const u32 rankSize, u64 sliceSize);
