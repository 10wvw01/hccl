...
#ifndef ALL_REDUCE_BIAR_H
#define ALL_REDUCE_BIAR_H
...
class AllReduceBIAR : public AlgTemplateBaseExperimental {
public:
    explicit AllReduceBIAR();

    ~AllReduceBIAR() override;  

    // should be called soon after template AllReduceBIAR instance created
...
protected:
    ...
    HcclResult RunReduceScatter(const u32 rank, const u32 rankSize, std::vector<ChannelInfo> &channels,
                                u64 sliceSize, u64 localStrideSize);
    HcclResult RunAllGather(const u32 rank, const u32 rankSize, std::vector<ChannelInfo> &channels,
                                u64 sliceSize, u64 localStrideSize);


    HcclResult PrepareSlicesData(const u32 unitSize, const u64 totalCount, const u32 rankSize) const;
    HcclResult HCCSProcessRsLoop(u32 round, const u32 rank, const u32 rankSize, u32 rankSizeX_,
                            u64 sliceSize, u64 localStrideSize);
    HcclResult SIOProcessRsLoop(u32 round, const u32 rank, const u32 rankSize, u32 rankSizeX_,
                            u64 sliceSize, u64 localStrideSize);
    HcclResult LocalCopyRsLoop(u32 round, const u32 rank, const u32 rankSize, u32 rankSizeX_,
                            u64 sliceSize, u64 localStrideSize);
    HcclResult TreeReduceRs(const u32 rank, const u32 rankSize, u32 rankSizeX_, u64 sliceSize,
                            u64 localStrideSize);
    HcclResult LocalReduceCCLToCCL(u64 srcOffset, u64 dstOffset, u64 size, ThreadHandle thread);

    HcclResult HCCSProcessAgLoop(u32 round, const u32 rank, const u32 rankSize, u32 rankSizeX_,
                            u64 sliceSize, u64 localStrideSize);
    HcclResult SIOProcessAgLoop(u32 round, const u32 rank, const u32 rankSize, u32 rankSizeX_,
                            u64 sliceSize, u64 localStrideSize);
    HcclResult LocalCopyAgLoop(u32 round, const u32 rank, const u32 rankSize, u32 rankSizeX_,
                            u64 sliceSize, u64 localStrideSize);
