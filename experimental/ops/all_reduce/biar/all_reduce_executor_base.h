...
#ifndef ALL_REDUCE_EXECUTOR_H
#define ALL_REDUCE_EXECUTOR_H
...
class AllReduceExecutorBase : public ExecutorBase {
public:
    explicit AllReduceExecutorBase();
    ~AllReduceExecutorBase() override = default;
