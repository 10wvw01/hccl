...
#ifndef ALL_REDUCE_BIRS_EXECUTOR_H
#define ALL_REDUCE_BIRS_EXECUTOR_H
...
class AllReduceBIARExecutor : public AllReduceExecutorBase {
public:
    explicit AllReduceBIARExecutor();
    ~AllReduceBIARExecutor() override = default;
...
private:
    HcclResult SelectAndPrepareBirsTemplate(bool isSingleServer, u32 localRank, u32 localRankSize,
