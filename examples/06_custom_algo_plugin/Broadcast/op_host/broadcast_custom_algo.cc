...
extern "C" HcclResult HcclAlgoPluginBroadcastTree(void* buf, uint64_t count, HcclDataType dataType,
    uint32_t root, HcclComm comm, aclrtStream stream)
{
    (void)comm; (void)stream; (void)buf;
    std::fprintf(stderr, "[BroadcastCustomAlgoImpl] HcclAlgoPluginBroadcastTree invoked: "
