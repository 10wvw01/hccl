...
// #define CCU_DECLARE_ARG_IDX(argName, argIdx) constexpr uint32_t CCU_ARG_IDX_##argName = argIdx;
// #define CCU_GET_ARG_IDX(argName) CCU_ARG_IDX_##argName

// CCU_DECLARE_ARG_IDX(inputAddr, 0)
// CCU_DECLARE_ARG_IDX(outputAddr, 1)
// CCU_DECLARE_ARG_IDX(token, 2)
// CCU_DECLARE_ARG_IDX(currentRankSliceInputOffset, 3)
// CCU_DECLARE_ARG_IDX(currentRankSliceOutputOffset, 4)
// CCU_DECLARE_ARG_IDX(sliceSize, 5)
// CCU_DECLARE_ARG_IDX(goSize0, 6)
// CCU_DECLARE_ARG_IDX(goSize1, 7)
// CCU_DECLARE_ARG_IDX(goSize2, 8)
// CCU_DECLARE_ARG_IDX(goSize3, 9)
// CCU_DECLARE_ARG_IDX(arg, 10)
