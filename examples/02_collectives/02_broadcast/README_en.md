...
This sample demonstrates how to perform a Broadcast operation using the `HcclBroadcast()` interface. It covers the following features:
...
- Call the `HcclBroadcast()` interface to broadcast the data of the root node to other ranks in the communication domain and print the result.
