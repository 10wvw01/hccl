...
The root node's data is initialized with values from 0 to 7. After the Broadcast​ operation, the root node's data is broadcast to all other ranks in the communicator.
