...
This sample demonstrates how to perform an AllReduce operation using the `HcclAllReduce()` interface. It covers the following features:
...
- Call the `HcclAllReduce()` operator to add up the input data of all ranks in the communication domain, send the result to all nodes, and print the result.
