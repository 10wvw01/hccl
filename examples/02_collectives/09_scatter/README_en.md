...
This sample demonstrates how to perform collective communication using the `HcclScatter()` interface. It covers the following features:
...
- Call the `HcclScatter()` interface to evenly divide and distribute the data of the root node in the communication domain to other ranks and print the result.
