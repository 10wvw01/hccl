...
This sample demonstrates how to perform an AlltoAll operation using the `HcclAlltoAll()` interface. It covers the following features:
...
- Call the `HcclAlltoAll()` operator to split the input data into a specific number of blocks along a specific dimension, send them to other ranks in order, receive data from other ranks, concatenate the data along a specific dimension, and print the result.
